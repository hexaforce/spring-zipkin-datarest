...
java -cp target/sleuth-webmvc-*-exec.jar \
  -Dlogging.level.org.springframework.cloud.sleuth=DEBUG \
  -Dspring.zipkin.baseUrl=http://zipkin:9411 \
  -Dspring.example.backendBaseUrl=http://backend:9000 \
